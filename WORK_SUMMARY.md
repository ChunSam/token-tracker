...
3. API 실패 시 `~/.codex/sessions/**/rollout-*.jsonl`의 최신 `token_count.rate_limits`를 읽는다.
...
```bash
open "/Volumes/SSD/Projects/Token tracker/.build/Token Tracker.app"
```
...
```text
/Volumes/SSD/Projects/Token tracker/.build/Token Tracker.app
```
